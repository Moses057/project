...
<form method="post">
    ...
    <select id="programId" name="programId">
        <option value="Public_relations">Public_relations</option>
        <option value="Political_science">Political_science</option>
        <option value="Pure_geography">Pure_geography</option>
